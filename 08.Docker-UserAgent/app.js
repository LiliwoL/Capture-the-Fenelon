...
const userAgentPage1 = process.env.FENELON1_UA || "GoogleBot";
const userAgentPage2 = process.env.FENELON2_UA || "DefaultAgent2/2.0";
const userAgentPage3 = process.env.FENELON3_UA || "DefaultAgent3/3.0";


const fenelon1 = process.env.FENELON1;
const fenelon2 = process.env.FENELON2;
const fenelon3 = process.env.FENELON3;
...
app.get('/fenelon1', (req, res) => {
    ...
    if (userAgent && userAgent.includes(userAgentPage1)) {
        res.render('fenelon1.html', { fenelon: fenelon1});
    } else {
...
app.get('/fenelon2', (req, res) => {
    ...
    if (userAgent && tousTrouves) {
        ...
        res.render('fenelon2.html', { fenelon: fenelon2});
...
app.get('/fenelon3', (req, res) => {
    ...
    if (userAgent && userAgent.includes(userAgentPage3)) {
        res.render('fenelon3.html', { fenelon: fenelon3});
    } else {
